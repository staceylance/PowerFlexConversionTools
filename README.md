...
<ol>
    ...
    <li>If you are migrating from an ArmorStart (284D) to an ArmorPowerflex, then you can use the APF_Dnet_Converter Jupyter Notebook for that. You still have to manually build the AOP for the new drive, but you usually don't have to consider parameters.</li>
</ol>
